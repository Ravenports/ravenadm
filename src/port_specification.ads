...
package Port_Specification is
   ...
   type spec_field is (sp_namebase, sp_version, sp_revision, sp_epoch, sp_keywords,
                       ...
                       sp_cgo_iargs, sp_cgo_feat, sp_verbatim, sp_kaiju, sp_procfs, sp_cve,
                       sp_smf_methods);
...
private
   ...
   type described_option_set is
     (AALIB, ALSA, ASM, COLORD, CUPS, DBUS, DEBUG, DOCS, ICONV, IDN, IPV4, IPV6, JAVA,
      LANG_CN, LANG_KO, LANG_RU,
      LDAP, LDAPS, MYSQL, NAS, NLS, OPENGL, OSS, PERL540, PERL542, PGSQL, PNG, PULSEAUDIO,
      PY313, PY314,
      READLINE, RUBY33, RUBY34, RUBY40,
      SNDIO, SOUND, SQLITE, STATIC, SOLARIS, SYSLOG, TCL, TCLTK, THREADS, X11, ZLIB,
      OPT_NOT_DEFINED);

   type gnome_type is
     (atk, cairo, glib, gtk2, gtk3, gtk4, gdkpixbuf, intltool, introspection,
      pango, pygobject, libcroco, libglade, libgsf, librsvg, libxml2, libxslt,
      dconf, gconf, libidl, orbit2, vte, libxmlxx5, libsigcxx2, libsigcxx3, glibmm, glibmm24,
      cairomm, cairomm10, atkmm, atkmm16, pangomm, pangomm14, gtkmm30, gtkmm40,
      gtksourceview3, gtksourceview4, gtksourceview5,
      invalid_component);
   ...
   type sdl_type is
     (sdl1, sdl2, sound1, sound2, image1, image2, mixer1, mixer2, net1, net2, ttf1, ttf2,
      invalid_component);
   ...
   type Portspecs is tagged
      record
         ...
         smf_methods    : string_crate.Vector;
