...
private
   ...
   type xorg_type is
     (bigreqsproto, compositeproto, damageproto, dmxproto, dri2proto, dri3proto, evieproto,
      ...
      xcb_util, xcb_util_cursor, xcb_util_image, xcb_util_keysyms, xcb_util_wm, xcb_render_util,
      xcomposite, xcursor, xdamage, xdmcp, xext, xfixes, xfont, xfont2, xfontcache, xft, xi,
      xinerama, xkbfile, xmu, xp, xpm, xprop, xrandr, xrender, xres, xscrnsaver, xset,
      xshmfence, xt, xtst, xv, xvmc, xxf86vm, invalid_component);
