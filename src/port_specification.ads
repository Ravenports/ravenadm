...
package Port_Specification is
   ...
   type spec_option  is (not_helper_format, not_supported_helper, broken_on, buildrun_depends_off,
                         ...
                         configure_with_both, cppflags_off, cppflags_on, cxxflags_on,
                         df_index_off, df_index_on,
                         extra_patches_on, extract_only_on, implies_on, info_off, info_on,
                         install_target_on, keywords_on, ldflags_off, ldflags_on,
                         make_args_off, make_args_on,
...
private
   ...
   type described_option_set is
     (AALIB, ALSA, ASM, COLORD, CUPS, DBUS, DEBUG, DOCS, FIREBIRD, ICONV, IDN, IPV4, IPV6, JAVA,
      ...
      LDAP, LDAPS, MYSQL, NAS, NLS, OPENGL, OSS, PERL528, PERL526, PGSQL, PNG, PULSEAUDIO,
      PY27, PY36, PY37,
      READLINE, RUBY23, RUBY24, RUBY25,
   ...
   type xorg_type is
     (xorgproto, fontcacheproto, printproto, xtransproto,
      ...
      xscrnsaver, xset, xshmfence, xt, xtst, xv, xvmc, xxf86dga, xxf86misc, xxf86vm, xbitmaps,
      invalid_component);
