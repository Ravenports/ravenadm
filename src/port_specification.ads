...
private
   ...
   type described_option_set is
     (ASM, DEBUG, ICONV, IDN, IPV4, IPV6, JAVA,
      ...
      LDAP, LDAPS, MYSQL, NLS, PERL522, PERL524, PGSQL, PNG, PY27, PY34, PY35,
      SQLITE, STATIC, TCL, TCLTK, THREADS, ZLIB,
      OPT_NOT_DEFINED);

   type gnome_type is
     (cairo, glib, introspection, libxml2, libxslt, invalid_component);
   ...
   type xorg_type is
     (bigreqsproto, compositeproto, damageproto, dmxproto, dri2proto, dri3proto, evieproto,
      ...
      xinerama, xrender, xshmfence, xtst, xv, xvmc, xxf86vm,
      invalid_component);
