...
private
   ...
   type described_option_set is
     (ASM, DEBUG, ICONV, IDN, IPV4, IPV6, JAVA,
      ...
      LDAP, LDAPS, MYSQL, NLS, PGSQL, PNG, PY27, PY34, PY35,
      SQLITE, STATIC, TCL, TCLTK, THREADS, ZLIB,
      OPT_NOT_DEFINED);

   type gnome_type is
     (glib, libxml2, libxslt, invalid_component);
   ...
   type xorg_type is
     (bigreqsproto, compositeproto, damageproto, dmxproto, dri2proto, dri3proto, evieproto,
      ...
      xtransproto, ice, pciaccess, pixman, sm, x11, xau, xcb, xcb_util, xcb_render_util,
      xdamage, xdmcp, xext, xfixes, xrender, xshmfence, xv, xvmc, xxf86vm,
      invalid_component);
