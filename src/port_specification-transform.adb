...
package body Port_Specification.Transform is
   ...
   is
      module     : String := "gmake";
      dependency : String := "gmake:primary:standard";
   begin
      generic_build_module (specs, module, dependency);
   ...
   is
      module     : String := "cmake";
      dependency : String := "cmake:primary:standard";
   begin
      if specs.uses_base.Contains (HT.SUS (module)) then
   ...
   begin
      ...
      if not no_arguments_present (specs, module) then
         if argument_present (specs, module, "83") then
            flavor := "php83";
   ...
   begin
      if not no_arguments_present (specs, php_module) then
         if argument_present (specs, php_module, "83") then
            flavor := "php83";
   ...
   begin
      if setting = "12" then
         ...
         --  case: setting = ports_default
         --  case: setting = default_pgsql (15 right now)
         --  case: setting = invalid value
         return "postgresql15";
      end if;
