...
package body Port_Specification.Transform is
      ...
      if specs.uses_base.Contains (HT.SUS (module)) then
         if not no_arguments_present (specs, module) then
            if argument_present (specs, module, "v34") then
               flavor := "v34";
            elsif argument_present (specs, module, "v40") then
               flavor := "v40";
   ...
   is
      ...
      begin
         if argument_present (specs, module, perl_544) then
            dep_suffix := perl_544;
            return primary_triplet ("perl-5.44");
   ...
   begin
      if setting = "innovation" then
         ...
         return "mariadb118";
      elsif setting = "mariadb-12.3" then
         return "mariadb123";
